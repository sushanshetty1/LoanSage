...
const MortgagePage = () => {
  ...
  const features = [
    "Instant mortgage eligibility check",
    "Compare interest rates across lenders",
    "Multilingual support in 10 Indian languages",
    "Voice-enabled mortgage application process",
    "Step-by-step guidance from Sage AI",
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 lg:gap-12 max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <span className="text-white">Your Dream Home with </span>
            ...
            >
              Get tailored mortgage solutions, compare rates, and complete your
              application in your preferred language — by text or voice.
            </motion.p>
                ...
                >
                  <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl rounded-tr-none p-4 shadow-sm">
                    <p className="text-white">
                      I need a mortgage loan of ₹1 crore. Can you help me?
                    </p>
                  </div>
                ...
                >
                  <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 border border-gray-700/50 shadow-sm">
                    <p className="text-gray-200 mb-3">
                      I can help you with that! Here are some mortgage loan
                      options for ₹1 crore:
                    </p>
                    ...
                    <p className="text-gray-300 mt-3 text-sm">
                      Would you like to apply for any of these options?
                    </p>
